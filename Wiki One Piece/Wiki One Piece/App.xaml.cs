    ...
    sealed partial class App : Application
    {
        ...
        protected override async void OnLaunched(LaunchActivatedEventArgs args)
        {
            ...
            if (rootFrame.Content == null)
            {
                ...
                // paramètre
                if (!rootFrame.Navigate(typeof(Welcome), "AllGroups"))
                {
        ...
        protected async override void OnSearchActivated(Windows.ApplicationModel.Activation.SearchActivatedEventArgs args)
        {
            ...
            if (frame == null)
            {
                ...
                frame = new Frame();
                Wiki_One_Piece.Common.SuspensionManager.RegisterFrame(frame, "AppFrame");
                ...
                if (args.PreviousExecutionState == ApplicationExecutionState.Terminated)
                {
                    ...
                    try
                    {
                        await Wiki_One_Piece.Common.SuspensionManager.RestoreAsync();
                    }
                    catch (Wiki_One_Piece.Common.SuspensionManagerException)
                    {
                        //Un problème est survenu lors de la restauration de l'état.
