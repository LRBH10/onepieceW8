...
namespace Wiki_One_Piece
{
    ...
    /// </summary>
    public sealed partial class PersonnageDetails : Wiki_One_Piece.Common.LayoutAwarePage
    {
        public PersonnageDetails()
        {
        ...
        protected override void LoadState(Object navigationParameter, Dictionary<String, Object> pageState)
        {
            ...
            var item = DataPersonnages.GetItem((String)navigationParameter);
            if (item == null)
                item = DataFruits.GetItem((String)navigationParameter);
