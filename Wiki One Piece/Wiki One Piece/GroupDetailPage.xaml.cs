...
namespace Wiki_One_Piece
{
    ...
    /// qu'il contient.
    /// </summary>
    public sealed partial class GroupDetailPage : Wiki_One_Piece.Common.LayoutAwarePage
    {
        ...
        protected override void LoadState(Object navigationParameter, Dictionary<String, Object> pageState)
        {
            ...
            var group = DataPersonnages.GetGroup((String)navigationParameter);
            if (group == null)
            {
                group = DataFruits.GetGroup((string)navigationParameter);
            }
