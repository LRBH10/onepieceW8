...
namespace Wiki_One_Piece
{
    ...
    /// </summary>
    public sealed partial class GroupedItemsPage : Wiki_One_Piece.Common.LayoutAwarePage
    {
        ...
        protected override void LoadState(Object navigationParameter, Dictionary<String, Object> pageState)
        {
            ...
            if (param == "Personnages")
            {
                var loader = new Windows.ApplicationModel.Resources.ResourceLoader();
                this.pageTitle.Text = loader.GetString("personnages");


                var sampleDataGroups = DataPersonnages.GetGroups("AllGroups");
                this.DefaultViewModel["Groups"] = sampleDataGroups;
            }
            else if (param == "Fruits de Démon")
            {
                var loader = new Windows.ApplicationModel.Resources.ResourceLoader();
                this.pageTitle.Text = loader.GetString("fruits");

                var sampleDataGroups = DataFruits.GetGroups("AllGroups");
                this.DefaultViewModel["Groups"] = sampleDataGroups;
            }
        ...
        void ItemView_ItemClick(object sender, ItemClickEventArgs e)
        {
            ...
            if (((SampleDataItem)e.ClickedItem).Group.Filter == "Personnage")
            {
                this.Frame.Navigate(typeof(PersonnageDetails), itemId);
            }
            else
            {
